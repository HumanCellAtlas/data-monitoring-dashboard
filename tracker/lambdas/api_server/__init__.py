...
from ...common.exceptions import TrackerException
...
def create_app():
    ...
    resolver = RestyResolver("tracker.api_server", collection_endpoint_name="list")
    swagger_spec_path = os.path.join(os.path.dirname(__file__), '..', '..', '..', 'config', 'tracker-api.yml')
